...
<div class="container">
  <h2>Tambah data</h2>
  <p>Silakan tambah data minuman di bawah ini! </p>
  <form action="tambah-fungsi.php"method="POST" class="needs-validation" novalidate>
    <div class="form-group">
      <label for="nama">Nama minuman : </label>
      <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama mminuman" name="nama" required>
      <div class="invalid-feedback">Nama minuman harus diisi!</div>
    </div>
    <div class="form-group">
      <label for="jenis_minuman">Jenis minuman : </label>
      <input type="jenis_minuman" class="form-control" id="jenis_minuman" placeholder="Masukkan jenis mminuman" name="jenis_minuman" required>
